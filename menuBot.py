...
m_main = Menu("Главное меню1", buttons=["Развлечения", "Игры", "ДЗ", "Помощь"])
...
m_fun = Menu("Развлечения", buttons=["Прислать кота", "Прислать анекдот", "Прислать картинку", "Выход"], parent=m_main)